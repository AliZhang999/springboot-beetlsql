...
public class Master2016Dao{
    ...
    public List<Map> get高层次人才统计() {
        return master2016SQLManager.select("common.分专业高层次人才统计",Map.class);
    }

    public List<Map> get师资结构统计(){
        return master2016SQLManager.select("common.分专业师资结构统计",Map.class);
    }

    public List<Map> get专职教师统计() {
        return master2016SQLManager.select("master2016.分专业专职教师统计",Map.class);
    }

    public List<Map> get教学团队统计() {
        return master2016SQLManager.select("common.分专业教学团队统计",Map.class);
    }

    public List<Map> get生源统计() {
        return master2016SQLManager.select("master2016.分专业生源统计",Map.class);
    }

    public List<Map> get留学生统计() {
        return master2016SQLManager.select("common.分专业留学生统计",Map.class);
    }

    public List<Map> get学生交流统计() {
        return master2016SQLManager.select("common.分专业学生交流统计",Map.class);
    }

    public List<Map> get毕业生统计() {
        return master2016SQLManager.select("common.分专业毕业生统计",Map.class);
    }
    ...
    public List<Option> get专业技术职称指标类型() {
        return master2016SQLManager.select("common.获取专业技术职称指标",Option.class);
    }

    public List<Option> get高层次人才指标类型() {
        return master2016SQLManager.select("common.获取高层次人才指标",Option.class);
    }

    public List<Option> get教师情况指标类型() {
        return master2016SQLManager.select("common.获取教师情况指标",Option.class);
    }

    public List<Option> get学历情况指标类型() {
        return master2016SQLManager.select("common.获取学历情况指标",Option.class);
    }

    public List<Option> get最高学位指标类型() {
        return master2016SQLManager.select("common.获取最高学位指标",Option.class);
    }

    public List<Option> get高层次研究团队指标类型() {
        return master2016SQLManager.select("common.获取高层次研究团队指标",Option.class);
    }

    public List<Map> get专业技术职称指标趋势统计(Map<String,Object> paras){
        return master2016SQLManager.select("common.专业技术职称指标趋势统计",Map.class,paras);
    }

    public List<Map> get专业技术职称指标对比统计(Map<String,Object> paras){
        return master2016SQLManager.select("common.专业技术职称指标对比统计",Map.class,paras);
    }

    public List<Map> get教师情况指标趋势统计(Map<String,Object> paras){
        return master2016SQLManager.select("common.教师情况指标趋势统计",Map.class,paras);
    }

    public List<Map> get教师情况指标对比统计(Map<String,Object> paras){
        return master2016SQLManager.select("common.教师情况指标对比统计",Map.class,paras);
    }

    public List<Map> get学历情况指标趋势统计(Map<String,Object> paras){
        return master2016SQLManager.select("common.学历情况指标对比统计",Map.class,paras);
    }
    ...
    public List<Map> get最高学位指标趋势统计(Map<String,Object> paras){
        return master2016SQLManager.select("common.最高学位指标趋势统计",Map.class,paras);
    }

    public List<Map> get最高学位指标对比统计(Map<String,Object> paras){
        return master2016SQLManager.select("common.最高学位指标对比统计",Map.class,paras);
    }

    public List<Map> get高层次人才指标趋势统计(Map<String,Object> paras){
        return master2016SQLManager.select("common.高层次人才指标趋势统计",Map.class,paras);
    }

    public List<Map> get高层次人才指标对比统计(Map<String,Object> paras){
        return master2016SQLManager.select("common.高层次人才指标对比统计",Map.class,paras);
    }

    public List<Map> get高层次研究团队指标趋势统计(Map<String,Object> paras){
        return master2016SQLManager.select("common.高层次研究团队指标趋势统计",Map.class,paras);
    }

    public List<Map> get高层次研究团队指标对比统计(Map<String,Object> paras){
        return master2016SQLManager.select("common.高层次研究团队指标对比统计",Map.class,paras);
    }
